# Generated by Django 4.2.7 on 2024-05-31 06:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='layer',
            name='default_style',
            field=models.ForeignKey(blank=True, help_text='Default layer style', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='default_style', to='context_layer_management.style'),
        ),
        migrations.AddField(
            model_name='layer',
            name='styles',
            field=models.ManyToManyField(blank=True, help_text='Style list for the layer.', to='context_layer_management.style'),
        ),
    ]
